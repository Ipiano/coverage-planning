    ...
    Values(
        ...
        PolygonAndDcel {{{{0, 0}, {0, 10}, {10, 10}, {10, 0}}, {{{4, 2}, {4, 4}, {3, 5}, {4, 6}, {4, 8}, {8, 8}, {8, 2}}}},
                        {{{{0, 0}, {0, 10}, {3, 10}, {3, 5}, {3, 0}},
                          {{3, 10}, {8, 10}, {8, 8}, {4, 8}, {3, 5}},
                          {{3, 0}, {3, 5}, {4, 4}, {8, 4}, {8, 0}},
                          {{8, 0}, {8, 4}, {8, 8}, {8, 10}, {10, 10}, {10, 0}}}}},

        // One multi-point convexity on opening side of inner loop
        PolygonAndDcel {
            {{{0, 0}, {0, 10}, {10, 10}, {10, 0}}, {{{4, 2}, {4, 4}, {3.5, 4.25}, {2, 5}, {3.5, 5.75}, {4, 6}, {4, 8}, {8, 8}, {8, 2}}}},
            {{{{0, 0}, {0, 10}, {2, 10}, {2, 5}, {2, 0}},
              {{2, 10}, {8, 10}, {8, 8}, {4, 8}, {4, 6}, {3.5, 5.75}, {2, 5}},
              {{2, 0}, {2, 5}, {3.5, 4.25}, {4, 4}, {4, 2}, {8, 2}, {8, 0}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        ...
        PolygonAndDcel {
            {{{-3, 0}, {-3, -2}, {-2, -3}, {0, -5}, {-2, -7}, {-3, -8}, {-3, -10}, {-10, -10}, {-10, 0}}},
            {{{{-3, -2}, {-2, -3}, {0, -5}, {-2, -7}, {-3, -8}}, {{-3, 0}, {-3, -2}, {-3, -8}, {-3, -10}, {-10, -10}, {-10, 0}}}}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        ...
        PolygonAndDcel {{{{0, 0}, {0, -10}, {-10, -10}, {-10, 0}},
                         {{{-4, -2}, {-4, -4}, {-3.5, -4.25}, {-2, -5}, {-3.5, -5.75}, {-4, -6}, {-4, -8}, {-8, -8}, {-8, -2}}}},
                        {{{{0, 0}, {0, -10}, {-2, -10}, {-2, -5}, {-2, 0}},
                          {{-2, -10}, {-8, -10}, {-8, -8}, {-4, -8}, {-4, -6}, {-3.5, -5.75}, {-2, -5}},
                          {{-2, 0}, {-2, -5}, {-3.5, -4.25}, {-4, -4}, {-4, -2}, {-8, -2}, {-8, 0}},
                          {{-8, -10}, {-10, -10}, {-10, 0}, {-8, 0}, {-8, -2}, {-8, -8}}}}},
